...
export function ServicesSection() {
  ...
  return (
    <section id="services" className="bg-[var(--bg-inverted)] rounded-t-[40px] sm:rounded-t-[50px] md:rounded-t-[60px] px-5 sm:px-8 md:px-10 py-20 sm:py-24 md:py-32">
      <FadeIn y={30}>
        <h2 className="text-[var(--bg-primary)] font-black uppercase text-center text-[clamp(3rem,12vw,160px)] mb-16 sm:mb-20 md:mb-28 leading-none">
          Services
        </h2>
      </FadeIn>
            ...
            >
              ...
              <div className="flex flex-col gap-2 md:gap-4 flex-1">
                <div className="flex items-center justify-between">
                  <h3 className="text-[var(--bg-primary)] font-medium uppercase text-[clamp(1rem,2.2vw,2.1rem)] leading-tight">
                    {service.name}
                  </h3>
                  <ArrowUpRight className="w-6 h-6 sm:w-8 sm:h-8 text-[var(--bg-primary)] opacity-60 sm:opacity-40 group-hover:opacity-100 group-hover:translate-x-1 group-hover:-translate-y-1 transition-all duration-200 shrink-0 ml-4" />
                </div>
                <p className="text-[var(--bg-primary)] font-light leading-relaxed max-w-2xl text-[clamp(0.85rem,1.6vw,1.25rem)] opacity-60">
                  {service.description}
                </p>
              </div>
            </Link>
